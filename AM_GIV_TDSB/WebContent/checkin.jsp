...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <div class="wrapper">
		...
		<main>
		<form action="CheckIn" method="get" class="formulario">
	        <div>
	            <h2>Código da Reserva </h2>
	            <input type="text" id="codReserva" name="codReserva" value="${reserva.codReserva}" size="5" class="input_cod" onkeypress='return SomenteNumero(event)' maxlength="6" readonly>
	        </div>
	        <div class="wpcf7">
	        <div id="placeStatus">
